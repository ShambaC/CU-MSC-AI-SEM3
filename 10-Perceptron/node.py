...
# percept = Perceptron(X.shape[1], 42)
...
def objective(trial) :
    ...
    thresh = trial.suggest_float('threshold', 0.5, 1.0)

    percept = Perceptron(X.shape[1], 69)
    percept.fit(X_train, y_train, epochs, lr, thresh)
